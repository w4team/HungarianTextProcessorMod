...
{
    public class HungarianTextProcessor : LanguageSpecificTextProcessor
    {
        public override CultureInfo CultureInfoForLanguage
        {
            get
            {
                return HungarianTextProcessor.CultureInfo;
            }
        }

        public override void ClearTemporaryData()
        {
            HungarianTextProcessor.LinkList.Clear();
            HungarianTextProcessor.WordGroups.Clear();
            HungarianTextProcessor.WordGroupsNoTags.Clear();
            HungarianTextProcessor._curGender = HungarianTextProcessor.WordGenderEnum.NoDeclination;
            HungarianTextProcessor._doesComeFromWordGroup = false;
        }
        ...
        private bool MasculineAnimate
        {
            get
            {
                return HungarianTextProcessor._curGender == HungarianTextProcessor.WordGenderEnum.MasculineAnimate;
            }
        }
        ...
        private bool MasculineInanimate
        {
            get
            {
                return HungarianTextProcessor._curGender == HungarianTextProcessor.WordGenderEnum.MasculineInanimate;
            }
        }
        ...
        private bool Masculine
        {
            get
            {
                return HungarianTextProcessor._curGender == HungarianTextProcessor.WordGenderEnum.MasculineAnimate || HungarianTextProcessor._curGender == HungarianTextProcessor.WordGenderEnum.MasculineInanimate;
            }
        }
        ...
        private bool FeminineAnimate
        {
            get
            {
                return HungarianTextProcessor._curGender == HungarianTextProcessor.WordGenderEnum.FeminineAnimate;
            }
        }
        ...
        private bool FeminineInanimate
        {
            get
            {
                return HungarianTextProcessor._curGender == HungarianTextProcessor.WordGenderEnum.FeminineInanimate;
            }
        }
        ...
        private bool Feminine
        {
            get
            {
                return HungarianTextProcessor._curGender == HungarianTextProcessor.WordGenderEnum.FeminineAnimate || HungarianTextProcessor._curGender == HungarianTextProcessor.WordGenderEnum.FeminineInanimate;
            }
        }
        ...
        private bool Neuter
        {
            get
            {
                return HungarianTextProcessor._curGender == HungarianTextProcessor.WordGenderEnum.NeuterInanimate || HungarianTextProcessor._curGender == HungarianTextProcessor.WordGenderEnum.NeuterAnimate;
            }
        }
        ...
        private bool NeuterInanimate
        {
            get
            {
                return HungarianTextProcessor._curGender == HungarianTextProcessor.WordGenderEnum.NeuterInanimate;
            }
        }
        ...
        private bool NeuterAnimate
        {
            get
            {
                return HungarianTextProcessor._curGender == HungarianTextProcessor.WordGenderEnum.NeuterAnimate;
            }
        }
        ...
        private bool Animate
        {
            get
            {
                return HungarianTextProcessor._curGender == HungarianTextProcessor.WordGenderEnum.MasculineAnimate || HungarianTextProcessor._curGender == HungarianTextProcessor.WordGenderEnum.FeminineAnimate || HungarianTextProcessor._curGender == HungarianTextProcessor.WordGenderEnum.NeuterAnimate;
            }
        }
        ...
        private static List<string> WordGroupsNoTags
        {
            get
            {
                if (HungarianTextProcessor._wordGroupsNoTags == null)
                {
                    HungarianTextProcessor._wordGroupsNoTags = new List<string>();
                }
                return HungarianTextProcessor._wordGroupsNoTags;
            }
        }
        ...
        private static List<string> LinkList
        {
            get
            {
                if (HungarianTextProcessor._linkList == null)
                {
                    HungarianTextProcessor._linkList = new List<string>();
                }
                return HungarianTextProcessor._linkList;
            }
        }
        ...
        public override void ProcessToken(string sourceText, ref int cursorPos, string token, StringBuilder outputString)
        {
            ...
            {
                HungarianTextProcessor.LinkList.Add(sourceText.Substring(this.LinkTagLength));
            }
            ...
            else if (Array.IndexOf<string>(HungarianTextProcessor.GenderTokens.TokenList, token) >= 0)
            {
                if (token == ".MA")
                {
                ...
                {
                    HungarianTextProcessor.WordGroups.Add(new ValueTuple<string, int>(sourceText + "{.nn}", cursorPos));
                    HungarianTextProcessor.WordGroupsNoTags.Add(sourceText.Substring(cursorPos));
                }
            }
            ...
            else if (Array.IndexOf<string>(HungarianTextProcessor.NounTokens.TokenList, token) >= 0 && (!HungarianTextProcessor._doesComeFromWordGroup || (HungarianTextProcessor._doesComeFromWordGroup && HungarianTextProcessor._curGender == HungarianTextProcessor.WordGenderEnum.NoDeclination)) && this.IsWordGroup(token.Length, sourceText, cursorPos, out num2))
            {
                if (num2 >= 0)
                {
                    token = "{" + token + "}";
            ...
            else if (HungarianTextProcessor._curGender != HungarianTextProcessor.WordGenderEnum.NoDeclination)
            {
                string text2;
                int num3;
        ...
        {
            bool flag = char.IsUpper(outputString[outputString.Length - HungarianTextProcessor.WordGroupsNoTags[wordGroupIndex].Length]);
            string text = HungarianTextProcessor.WordGroups[wordGroupIndex].Item1;
            outputString.Remove(outputString.Length - HungarianTextProcessor.WordGroupsNoTags[wordGroupIndex].Length, HungarianTextProcessor.WordGroupsNoTags[wordGroupIndex].Length);
            ...
            HungarianTextProcessor._doesComeFromWordGroup = true;
        ...
        {
            int num = 0;
            while (num < HungarianTextProcessor.WordGroupsNoTags.Count && curPos - tokenLength - 2 - HungarianTextProcessor.WordGroupsNoTags[num].Length >= 0)
            {
                if (sourceText.Substring(curPos - tokenLength - 2 - HungarianTextProcessor.WordGroupsNoTags[num].Length, HungarianTextProcessor.WordGroupsNoTags[num].Length).Equals(HungarianTextProcessor.WordGroupsNoTags[num]))
                {
                    wordGroupIndex = num;
                    return true;
                }
        ...
        {
            char c = HungarianTextProcessor.GetLastCharacter(outputString);
            if (c == 'а' && !this.Neuter)
            {
                outputString.Remove(outputString.Length - 1, 1);
                c = HungarianTextProcessor.GetLastCharacter(outputString);
            ...
            else
            {
                ...
                if (!this.Neuter)
                {
                    ...
                    else
                    {
                        ...
                        if (this.MasculineAnimate && HungarianTextProcessor.GetEnding(outputString, 2) == "ин")
                        {
                        ...
                        {
                            if (this.Animate && (HungarianTextProcessor.GetEnding(outputString, 4) == "енок" || HungarianTextProcessor.GetEnding(outputString, 4) == "ёнок"))
                            {
                                outputString.Remove(outputString.Length - 4, 4).Append("ята");
                                return;
                            }
                            if (this.Animate && HungarianTextProcessor.GetEnding(outputString, 4) == "онок")
                            {
                                outputString.Remove(outputString.Length - 4, 4).Append("ата");
                                return;
                            }
                            if (HungarianTextProcessor.GetEnding(outputString, 2) == "ок" && outputString.ToString() != "сок")
                            {
                                outputString.Remove(outputString.Length - 2, 2).Append("ки");
                                return;
                            }
                            if (HungarianTextProcessor.GetEnding(outputString, 2) == "ек" && HungarianTextProcessor.GetEnding(outputString, 2) == "ёк")
                            {
                                if (this.IsConsonant(HungarianTextProcessor.GetEnding(outputString, 3)[0]))
                                {
                ...
                {
                    if (c == 'я' && HungarianTextProcessor.GetLastCharacter(outputString) == 'м')
                    {
            ...
            else
            {
                ...
                if (!this.Neuter)
                {
                    ...
                    else
                    {
                        ...
                        if (this.IsConsonant(c))
                        {
                            if (HungarianTextProcessor.GetEnding(outputString, 3) == "нок")
                            {
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (this.IsConsonant(c))
                    {
                        ...
                        {
                            if (HungarianTextProcessor.GetEnding(outputString, 2) == "нц")
                            {
        ...
        {
            char lastCharacter = HungarianTextProcessor.GetLastCharacter(outputString);
        ...
        private void AddSuffixNounInstrumental(StringBuilder outputString)
        {
            ...
            else
            {
                ...
                if (this.Neuter)
                {
                    ...
                    if (HungarianTextProcessor.GetEnding(outputString, 2) == "мя")
                    {
        ...
        {
            string ending = HungarianTextProcessor.GetEnding(outputString, 2);
            outputString.Remove(outputString.Length - 2, 2);
            if (ending == "ый")
            {
                if (this.Feminine)
        ...
        private void AddSuffixAdjectiveNominativePlural(StringBuilder outputString)
        {
            string ending = HungarianTextProcessor.GetEnding(outputString, 2);
            outputString.Remove(outputString.Length - 2, 2);
            string ending2 = HungarianTextProcessor.GetEnding(outputString, 1);
        ...
        {
            HungarianTextProcessor._curGender = HungarianTextProcessor.WordGenderEnum.FeminineAnimate;
        }

        private void SetFeminineInanimate()
        {
            HungarianTextProcessor._curGender = HungarianTextProcessor.WordGenderEnum.FeminineInanimate;
        }

        private void SetNeuterInanimate()
        {
            HungarianTextProcessor._curGender = HungarianTextProcessor.WordGenderEnum.NeuterInanimate;
        }

        private void SetNeuterAnimate()
        {
            HungarianTextProcessor._curGender = HungarianTextProcessor.WordGenderEnum.NeuterAnimate;
        }

        private void SetMasculineAnimate()
        {
            HungarianTextProcessor._curGender = HungarianTextProcessor.WordGenderEnum.MasculineAnimate;
        }

        private void SetMasculineInanimate()
        {
            HungarianTextProcessor._curGender = HungarianTextProcessor.WordGenderEnum.MasculineInanimate;
        }

        private bool IsRecordedWithPreviousTag(string sourceText, int cursorPos)
        {
            for (int i = 0; i < HungarianTextProcessor.WordGroups.Count; i++)
            {
                if (HungarianTextProcessor.WordGroups[i].Item1 == sourceText && HungarianTextProcessor.WordGroups[i].Item2 != cursorPos)
                {
                    return true;
                }
            }
        ...
        private void WordGroupProcessor(string sourceText, int cursorPos)
        {
            ...
            {
                HungarianTextProcessor.WordGroups.Add(new ValueTuple<string, int>(sourceText, cursorPos));
                string text = sourceText.Replace("{.nnp}", "{.p}");
                text = text.Replace("{.ajp}", "{.jp}");
                text = text.Replace("{.nn}", "{.n}");
                text = text.Replace("{.aj}", "{.j}");
                HungarianTextProcessor._doesComeFromWordGroup = true;
                HungarianTextProcessor.WordGroupsNoTags.Add(base.Process(text));
                HungarianTextProcessor._doesComeFromWordGroup = false;
            }
        }
        ...
        private bool IsLink(string sourceText, int tokenLength, int cursorPos)
        {
            ...
            for (int i = 0; i < HungarianTextProcessor.LinkList.Count; i++)
            {
                if (sourceText.Length >= HungarianTextProcessor.LinkList[i].Length && text.EndsWith(HungarianTextProcessor.LinkList[i]))
                {
                    HungarianTextProcessor.LinkList.RemoveAt(i);
                    return true;
                }
            }
            return false;
        ...
        private bool IsIrregularWord(string sourceText, int cursorPos, string token, out string irregularWord, out int lengthOfWordToReplace)
        {
            ...
            if (lengthOfWordToReplace > 0)
            {
                ...
                if (HungarianTextProcessor.exceptions.ContainsKey(text) && HungarianTextProcessor.exceptions[text] != null && HungarianTextProcessor.exceptions[text].ContainsKey(token))
                {
                    irregularWord = HungarianTextProcessor.exceptions[text][token];
                }
            }
        ...
        {
            return Array.IndexOf<char>(HungarianTextProcessor._vowels, c) >= 0;
        }

        private bool IsVelarOrSibilant(char c)
        {
            return Array.IndexOf<char>(HungarianTextProcessor._sibilants, c) >= 0 || Array.IndexOf<char>(HungarianTextProcessor._velars, c) >= 0;
        }
        ...
        private static string IrregularWordWithCase(string token, HungarianTextProcessor.IrregularWord irregularWord)
        {
            if (token == ".j")
            {
        ...
        public static string[] GetProcessedNouns(string str, string gender, string[] tokens = null)
        {
            ...
            HungarianTextProcessor HungarianTextProcessor = new HungarianTextProcessor();
            foreach (string text in tokens)
            {
                string text2 = string.Concat(new string[] { "{=!}", gender, str, "{", text, "}" });
                list.Add(HungarianTextProcessor.Process(text2));
            }
            return list.ToArray();
        }

        public HungarianTextProcessor()
        {
        }

        static HungarianTextProcessor()
        {
        }

        private static readonly CultureInfo CultureInfo = new CultureInfo("hu-HU");
        ...
        private static readonly Dictionary<char, List<HungarianTextProcessor.IrregularWord>> _irregularMasculineAnimateDictionary = new Dictionary<char, List<HungarianTextProcessor.IrregularWord>> {
        {
            'A',
            new List<HungarianTextProcessor.IrregularWord>
            {
                new HungarianTextProcessor.IrregularWord("Alary", "Alary", "Alarego", "Alarego", "Alaremu", "Alaremu", "Alarego", "Alarego", "Alarym", "Alarym", "Alarym", "Alarym")
            }
        } };

        private static readonly Dictionary<char, List<HungarianTextProcessor.IrregularWord>> _irregularMasculineInanimateDictionary = new Dictionary<char, List<HungarianTextProcessor.IrregularWord>> {
        {
            'A',
            new List<HungarianTextProcessor.IrregularWord>
            {
        ...
        private static readonly Dictionary<char, List<HungarianTextProcessor.IrregularWord>> _irregularFeminineAnimateDictionary = new Dictionary<char, List<HungarianTextProcessor.IrregularWord>> {
        {
            'A',
            new List<HungarianTextProcessor.IrregularWord>
            {
        ...
        private static readonly Dictionary<char, List<HungarianTextProcessor.IrregularWord>> _irregularFeminineInanimateDictionary = new Dictionary<char, List<HungarianTextProcessor.IrregularWord>> {
        {
            'A',
            new List<HungarianTextProcessor.IrregularWord>
            {
        ...
        private static readonly Dictionary<char, List<HungarianTextProcessor.IrregularWord>> _irregularNeuterAnimateDictionary = new Dictionary<char, List<HungarianTextProcessor.IrregularWord>> {
        {
            'A',
            new List<HungarianTextProcessor.IrregularWord>
            {
        ...
        private static readonly Dictionary<char, List<HungarianTextProcessor.IrregularWord>> _irregularNeuterInanimateDictionary = new Dictionary<char, List<HungarianTextProcessor.IrregularWord>> {
        {
            'A',
            new List<HungarianTextProcessor.IrregularWord>
            {
